...
# живой.
#
# 1 — проверять каждый прогон. С оговоркой: прогон идёт раз в сутки, и если
# с прошлой проверки прошло на пару минут меньше суток, ответ ещё считается
# свежим, и проверка сдвинется на следующий прогон. На деле страница
# проверяется раз в сутки или раз в двое.
